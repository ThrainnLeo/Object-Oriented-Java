package thrainn.Shapes; // TODO: Change to your package name
...
public class World {
    ...
    public World(double width, double height) {
        ...
        shapes[0] = new Line(0,0,100,200,Color.BLACK);
        shapes[0].setVelocity(300,300);

        shapes[1] = new Circle(100, true);
        shapes[1].setVelocity(100,100);

        shapes[2] = new Rectangle(100, true);
        shapes[2].setVelocity(150,150);
